...
public class CardSpawner : MonoBehaviour
{
    ...
    void Spawn()
    {
        ...
        var temp = _gameManager.gameObject.GetComponents<Component>();
        ...
        if (maxCards % 2 == 0)
        {
            ...
            if (sum < maxCards)
            {
                ...
                {
                    _cardsToSpawnCount[Random.Range(0, _cardsToSpawn.Count - 1)] += 2;
                }
            }
        ...
        var temp2 = _gameManager.gameObject.GetComponents<Component>();
    }
}